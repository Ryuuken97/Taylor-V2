...
handler.tags = ["ai"];
handler.command = /^(cgtai|goodyai|leptonai|letmegpt|thinkany|useadrenaline|degreeguru|ragbot|stoicgpt|stoicai)$/i;
handler.help = ["cgtai", "goodyai", "leptonai", "letmegpt", "thinkany", "useadrenaline", "degreeguru", "ragbot", "stoicgpt", "stoicai"];
